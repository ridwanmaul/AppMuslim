...
import paket.example.ProjectUas.Adapters.DaftarDzikirPagiAdapter;
import paket.example.ProjectUas.Generator.ServiceGenerator;
import paket.example.ProjectUas.Models.DaftarDzikirPagi;

import paket.example.ProjectUas.R;

import paket.example.ProjectUas.Services.DaftarDzikrPagiService;
...
public class DzikirPagiActivity extends AppCompatActivity implements DaftarDzikirPagiAdapter.OnDaftarClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listDaftarDzikirPagi.add(new DaftarDzikirPagi("[7]",
                "( Dibaca 1x )",
